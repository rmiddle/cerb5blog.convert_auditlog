...
<br>
<br>
<label><input type="radio" name="cal_all_enteries" value="1" {if $cal_all_enteries}checked="checked"{/if}> {$translate->_('cerb5blog.convert_auditlog.config.all_enteries.all')|capitalize}</label><br>
